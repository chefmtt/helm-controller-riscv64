...
import (
	...
	helmv1 "github.com/chefmtt/helm-controller-riscv64/pkg/apis/helm.cattle.io/v1"
	helmcontroller "github.com/chefmtt/helm-controller-riscv64/pkg/generated/controllers/helm.cattle.io/v1"
...
var (
	...
	DefaultJobImage = "matthieucx/klipper-helm:v0.6.6-build20211022"
)
